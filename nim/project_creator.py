# -*- coding: utf-8 -*-
"""
Created on Wed Apr 10 13:53:05 2024
...
def create_project():
    ...
    # Create main Nim file
    main_file = os.path.join(src_dir, project_name + ".nim")
    with open(main_file, "w") as f:
        f.write(f'echo "Hello, {project_name}!"')

    messagebox.showinfo("Success", f"Project '{project_name}' created successfully.")
    root.destroy()

root = tk.Tk()
root.title("Nim Project Creator")
